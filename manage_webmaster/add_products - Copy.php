...
if (!isset($_POST['submit']))  {
    ...
    foreach($product_weights as $key=>$value){
        ...
        $sql = "INSERT INTO product_weight_prices ( `product_id`,`weight_type_id`,`product_price`) VALUES ('$last_id','$product_weights1','$product_price')";
...
function addInput(divName) {
    ...
    var newTextBox = "<div class='form-group col-md-4'><input type='text' onkeypress='return isNumberKey(event)' onclick='addInput('dynamicInput');' required name='product_price[]' class='form-control' id='form-control-2' placeholder='Actual Price'></div>";

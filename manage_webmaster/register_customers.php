...
<?php $i=1;
      $getQry = "SELECT * FROM register_customers ORDER BY id DESC";  
                        ...
                        <div class="modal-content animated flipInX">
                          ...
                          <div class="modal-body" id="modal_body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6"><?php echo $row['customer_email'];?></div>
                            </div>
                            <div class="row">
                              <div class="col-sm-2"></div>
                              <div class="col-sm-4">Mobile:</div>
                              <div class="col-sm-6"><?php echo $row['customer_mobile'];?></div>
                            </div>
                            <div class="row">
                              <div class="col-sm-2"></div>

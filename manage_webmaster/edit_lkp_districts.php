...
if (!isset($_POST['submit'])) {
    ...
    $status = $_POST['status'];
      ...
      $sql = "UPDATE `lkp_districts` SET lkp_state_id = '$lkp_state_id', district_name = '$district_name', status='$status' WHERE id = '$id' ";
      ...
      <div class="site-content">
        <div class="panel panel-default">
          ...
          <div class="panel-body">            
            <div class="row">
              <?php $getDistricts = getDataFromTables('lkp_districts','0','id',$id,$activeStatus=NULL,$activeTop=NULL);
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="district_name" class="form-control" id="user_input" data-error="Please enter a District Name" required value="<?php echo $getDistrictsData['district_name'];?>" onkeyup="checkUserAvailTest()">
                  ...
                  <div class="form-group">
                    ...
                    <select id="form-control-3" name="lkp_status_id" class="custom-select" data-error="This field is required." required>
                      ...
                      <?php while($row = $getStatus->fetch_assoc()) {  ?>
                          <option <?php if($row['id'] == $getDistrictsData['status']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['status']; ?></option>
                      <?php } ?>
                    </select>
                    <div class="help-block with-errors"></div>
                  </div>

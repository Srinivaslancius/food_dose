      ...
      <div class="site-content">
        <div class="panel panel-default panel-table">
          <div class="panel-heading">
            ...
            <h3 class="m-t-0 m-b-5">Take Away Orders</h3> 
            <?php $sql ="SELECT * from orders WHERE order_status=5 GROUP BY order_id  ORDER BY id DESC";
              $res = $conn->query($sql);
              $i=1; 
            ?>
          </div>
              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php if ($res1['order_status']==1) { echo "Pending" ;} elseif($res1['order_status']==2) { echo "Completed" ;} elseif($res1['order_status']==3) { echo "cancelled" ;} elseif($res1['order_status']==5) { echo "Take Away" ;} else{ echo "New Orders";} ?></td>

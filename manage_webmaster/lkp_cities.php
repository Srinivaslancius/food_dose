              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <td><?php if ($row['status']==0) { echo "<span class='label label-outline-success check_active open_cursor' data-incId=".$row['id']." data-status=".$row['status']." data-tbname='lkp_cities'>Active</span>" ;} else { echo "<span class='label label-outline-info check_active open_cursor' data-status=".$row['status']." data-incId=".$row['id']." data-tbname='lkp_cities'>In Active</span>" ;} ?></td>
                   <td> <a href="edit_lkp_cities.php?cityid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-edit"></i></a></td>
                  </tr>
                  <?php  $i++; } ?>
                </tbody>
              </table>

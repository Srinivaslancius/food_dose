...
error_reporting(0);
 if (!isset($_POST['submit'])) {
    ...
    //If success            
      ...
      $answer = $_POST['answer'];
      $status = $_POST['status'];
        $sql = "INSERT INTO faqs (`faq`, `answer`,`status`) VALUES ('$faq', '$answer','$status')";
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" autocomplete="off">
                  <div class="form-group">
                    ...
                    <input type="text" name="faq" class="form-control" id="form-control-2" placeholder="Faq" data-error="Please enter faq" required>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Answer</label>
                    <textarea name="answer" class="form-control" id="answer" placeholder="Answer" data-error="This field is required." required></textarea>
                    <div class="help-block with-errors"></div>
                  </div>
